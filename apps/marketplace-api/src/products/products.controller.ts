...
export class ProductsController {
  ...
  @ApiOperation({
    summary: 'Obtener todos los productos (Solo administradores)',
    description:
      'Retorna la lista completa de productos en el marketplace. Permite filtrar por vendedor. Requiere autenticación y rol de administrador.',
  })
  @ApiBearerAuth()
  @ApiQuery({
    name: 'sellerId',
